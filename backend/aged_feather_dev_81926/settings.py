"""
Django settings for aged_feather_dev_81926 project.
...
ROOT_URLCONF = 'aged_feather_dev_81926.urls'
...
WSGI_APPLICATION = 'aged_feather_dev_81926.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_feather_dev_81926 API",
    "DESCRIPTION": "API documentation for aged_feather_dev_81926 App",
    "VERSION": "v1",
}
